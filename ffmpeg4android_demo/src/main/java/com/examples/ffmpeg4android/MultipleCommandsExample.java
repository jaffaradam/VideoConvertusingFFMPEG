...
public class MultipleCommandsExample extends Activity {
	...
	@Override
	  public void onCreate(Bundle savedInstanceState) {
		...
		String path = "ffmpeg -y -i"+tempPath+" -strict experimental -vf transpose=1 -s 160x120 -r 30 -aspect 4:3 -ab 48000 -ac 2 -ar 22050 -b 2097k /storage/emulated/0/videokit/out.mp4";
