...
public class SimpleExample extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tempPath = extras.getString("tempfile");
		Log.e("tempfile",tempPath);

		// /storage/emulated/0/TempVideo/save_1551697278249.mp4
		...
		String pathValue = String.valueOf(separated.length);
		String pathvalue1 = separated[5];
		Log.e("pathvalue",pathValue+","+pathvalue1);

		demoVideoFolder = Environment.getExternalStorageDirectory().getAbsolutePath() + "/TempVideo/";
		demoVideoPath = demoVideoFolder + pathvalue1;
		Log.e("demovideofolder",demoVideoPath);
	...
	public class TranscdingBackground extends AsyncTask<String, Integer, Integer>
	{
		...
		protected Integer doInBackground(String... paths) {
			...
			try {
				...
				String CopyVideoFolder = null;
				CopyVideoFolder = Environment.getExternalStorageDirectory().getAbsolutePath() + "/videokit1/";
				GeneralUtils.copyFileToFolder(vkLogPath, CopyVideoFolder);
